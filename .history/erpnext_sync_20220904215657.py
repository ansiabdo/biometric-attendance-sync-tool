...
def main():
    ...
    print("main ")
    try:
        print("datetime.datetime.now() = " + datetime.datetime.now().strftime())
...
def pull_process_and_push_data(device, device_attendance_logs=None):
    ...
    index_of_last = -1
    print("index_of_last = " + index_of_last)
    ...
    if last_line or import_start_date:
        ...
        for i, x in enumerate(device_attendance_logs):
            print("for i,= " + x['user_id'] + "  " + x['timestamp'].strftime())
    ...
    for device_attendance_log in device_attendance_logs[index_of_last+1:]:
        print("for device_attendance_log in " +
              device_attendance_log['user_id'] + "  " + device_attendance_log['timestamp'] + " " + device_attendance_log['punch'])
